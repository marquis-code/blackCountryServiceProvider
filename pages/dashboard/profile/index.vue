  ...
  <main>
    <div class="min-h-screen bg-gray-25 pb-10">
      <div class="max-w-xl mx-auto space-y-4 pt-10">
        <h3 class="text-[#1D2739] text-lg font-semibold pl-10 lg:pl-0">
          Profile
        </h3>
        <div class="max-w-sm mx-auto px-6 pb-6 text-center space-y-4 relative">
          ...
          <div class="relative inline-block">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              ...
              <!-- <span class="text-green-600 font-semibold">{{ completionPercentage }}%</span> -->
            </div>
          </div>
          ...
          <div>
            <div class="flex justify-center items-center">
              <span
                class="text-white rounded-full text-xs px-2 py-1 font-semibold bg-[#5B8469] absolute top-[81px]"
                >{{ percentage }}%</span
              >
            </div>
            <p class="text-xl font-bold text-[#1D2739]">
          ...
          <!-- Action Button -->
          <div
            class="flex justify-center items-center space-x-2 bg-[#F0F2F5] rounded-full py-2 px-4"
          >
            <p class="text-sm font-medium text-[#1D2739]">
...
const { completionPercentage } = useProfileCompletion(userData);
...
//   userObj.value = userData ? JSON.parse(userData) : null;
// });
...
const percentage = ref(completionPercentage.value);
...
const progressSize = computed(() => {
  return completionPercentage.value < 100 ? "4px" : "6px";
});
